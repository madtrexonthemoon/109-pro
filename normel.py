...
print("{}%  of data for height lies within 1 standerd deviation",format(len(height_list_of_data_within_1_std_deviation)*100.0/len(height_list)))
print("{}%  of data for height lies within 2 standerd deviation",format(len(height_list_of_data_within_2_std_deviation)*100.0/len(height_list)))
print("{}%  of data for height lies within 3 standerd deviation",format(len(height_list_of_data_within_3_std_deviation)*100.0/len(height_list)))
print("{}%  of data for weight lies within 1 standerd deviation",format(len(weight_list_of_data_within_1_std_deviation)*100.0/len(weight_list)))
print("{}%  of data for weight lies within 2 standerd deviation",format(len(weight_list_of_data_within_2_std_deviation)*100.0/len(weight_list)))
print("{}%  of data for weight lies within 3 standerd deviation",format(len(weight_list_of_data_within_3_std_deviation)*100.0/len(weight_list)))
